...
copyright = u'2018, Akash Kotadia'
...
latex_documents = [('index', 'Test.tex', u'Test Documentation', u'Akash Kotadia', 'manual')]
...
man_pages = [('index', 'Test', u'Test Documentation', [u'Akash Kotadia'], 1)]
